"""talentbid_21193 URL Configuration
...
admin.site.site_header = "TalentBid"
admin.site.site_title = "TalentBid Admin Portal"
admin.site.index_title = "TalentBid Admin"

# swagger
api_info = openapi.Info(
    title="TalentBid API",
    default_version="v1",
    description="API documentation for TalentBid App",
)
